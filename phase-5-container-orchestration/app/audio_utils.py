...
def slice_spectrogram(standardized_spectrogram):
    ...
    # subsequent spectrogram contain latter half of preprocessor
    stride_frames = 1000
    ...
    # loop step by step through entire input range, start at 0, end at end of input, move in stride_frames steps
    for step in range(0, total_frames, stride_frames):
        ...
        # calculate timestamp second for this step // 2000 frames = 4 secs; 1 frame = (4 / 2000) seconds
...
def preprocess_audio(audio_bytes: bytes): #in phase 3 this was a path but after adding the normalization function it expects raw audio bytes
    ...
    try:
        ...
        # --- WIP: slice_spectrogram(standardized_spectrogram) ---
        # --- ---
